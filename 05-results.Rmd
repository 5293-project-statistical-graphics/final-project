...
issue_and_pull_request %>%
  ...
  labs(x = "created at (year)", y = "percentage" ,
       title = "% of issues whose state are still open increases over the past few year for Plotly",
       subtitle = "ggplot2 v.s. plotly, % of issues and pull requests created each year whose state are still open over 2014-2021",
